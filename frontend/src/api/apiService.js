...
async function getValidationFromGradeType(type) {
  const gradeValidation = GRADE_VALIDATION.find(
    (item) => item.gradeType === type );
    return {
...
export { getAllGrades, deleteGrade, updateGrade, getValidationFromGradeType, insertGrade };